            ...
            {Object.values(authContext.pointsList).map((card, i)=>{
                return(<View key={i} style={{width: '98%', alignSelf: 'center', marginBottom: 30, height: 210, borderRadius: 20, backgroundColor: 'white', shadowColor: '#000', shadowOpacity: 1, elevation: 5, shadowOffset: { width: 0, height: 0 }}}>
                    <ImageBackground style={{width: '100%', opacity: 0.9, borderRadius: 20, height: 210}} imageStyle={{borderRadius: 10}} resizeMode= 'cover' source={{uri: card["restaurant_card_pic"]}}>
                        ...
                        {card["cummulative_rewards"]=== 0 ? <Text style={{position: 'absolute', bottom: 5, color: 'white', alignSelf: 'center', width: '75%', flexWrap: 'wrap', alignSelf: 'center', textAlign: 'center', fontWeight: 'bold', color: 'white', shadowColor: '#000', fontSize: 9, shadowOpacity: 1, elevation: 5, shadowOffset: { width: 0, height: 0 }}}></Text> : <Text style={{position: 'absolute', bottom: 5, color: 'white', alignSelf: 'center', width: '75%', flexWrap: 'wrap', alignSelf: 'center', textAlign: 'center', fontWeight: 'bold', color: 'white', shadowColor: '#000', fontSize: 9, shadowOpacity: 1, elevation: 5, shadowOffset: { width: 0, height: 0 }}}>You have already redeemed {card["cummulative_rewards"]-card["rewards"]} rewards!</Text>}
                        <View style={{flexDirection: 'row', alignSelf: 'center', marginTop: 20, maxWidth: '90%', alignSelf: 'center', flexWrap: 'wrap'}}>
